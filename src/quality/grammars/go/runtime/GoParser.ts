...
export class GoParser extends GoParserBase {
  ...
  public sempred(
    ...
    switch (ruleIndex) {
      case 64:
        return this.methodSpec_sempred(
          _localctx as MethodSpecContext,
          predIndex,
        );
  ...
  private methodSpec_sempred(
    _localctx: MethodSpecContext,
    predIndex: number,
  ): boolean {
    switch (predIndex) {
      case 0:
  ...
  private signature_sempred(
    _localctx: SignatureContext,
    predIndex: number,
  ): boolean {
    switch (predIndex) {
      case 1:
  ...
  private fieldDecl_sempred(
    _localctx: FieldDeclContext,
    predIndex: number,
  ): boolean {
    switch (predIndex) {
      case 8:
